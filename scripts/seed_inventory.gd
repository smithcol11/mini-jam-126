...
func _ready():
	...
	#Setup part plants
	gearPlant = {"ID": 1, "yieldMin": 10, "yieldMax": 25}
	pistonPlant = {"ID": 2, "yieldMin": 5, "yieldMax": 15}
	bearingPlant = {"ID": 3, "yieldMin": 5, "yieldMax": 10}
	fuelPlant = {"ID": 4, "yieldMin": 5, "yieldMax": 15}
	springPlant = {"ID": 5, "yieldMin": 1, "yieldMax": 2}
	
	#setup food plants
	potatoPlant = {"ID": 1, "mature_time": 30, "preferred_season": "SUMMER", "death_season": "WINTER", "food_restored": 60 }
	tomatoPlant = {"ID": 2, "mature_time": 45, "preferred_season": "SPRING", "death_season": "FALL", "food_restored": 90 }
	wheatPlant = {"ID": 3, "mature_time": 20, "preferred_season": "SUMMER", "death_season": "SPRING", "food_restored": 20 }
	carrotPlant = {"ID": 4, "mature_time": 60, "preferred_season": "SPRING", "death_season": "WINTER", "food_restored": 100 }
	broccoliPlant = {"ID": 5, "mature_time": 25, "preferred_season": "FALL", "death_season": "SUMMER", "food_restored": 75 }
